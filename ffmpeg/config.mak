...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./output/android --target-os=linux --arch=arm --disable-iconv --disable-doc --disable-indevs --disable-ffmpeg --disable-filters --disable-network --disable-debug --disable-ffplay --disable-ffserver --disable-bsfs --disable-encoders --disable-protocols --disable-parsers --disable-muxers --disable-decoders --enable-decoder=h264 --enable-decoder=vp8 --enable-decoder=wmv3 --disable-demuxers --disable-programs --enable-cross-compile --cross-prefix=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --cc=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --nm=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --ar=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar --as=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cxx=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --ld=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --extra-cflags='-MMD -MP -fPIC -ffunction-sections  -funwind-tables  -fstack-protector  -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__  -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__  -march=armv7-a  -mfloat-abi=softfp  -mfpu=vfp  -mthumb  -Os  -fomit-frame-pointer  -fno-strict-aliasing  -finline-limit=64  -DANDROID -Wa,--noexecstack  -I. -I/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/include ' --extra-cxxflags='-MMD -MP -fPIC -ffunction-sections  -funwind-tables  -fstack-protector  -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__  -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__  -march=armv7-a  -mfloat-abi=softfp  -mfpu=vfp  -mthumb  -Os  -fomit-frame-pointer  -fno-strict-aliasing  -finline-limit=64  -DANDROID -Wa,--noexecstack  -I. -I/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/include  -fno-exceptions -fno-rtti -I/opt/android-ndk-r14b/sources/cxx-stl/system/include -I/opt/android-ndk-r14b/sources/cxx-stl/stlport/stlport' --extra-ldflags='-L/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/lib -L/opt/android-ndk-r14b/sources/cxx-stl/stlport/libs/armeabi -shared --sysroot=/opt/android-ndk-r14b/platforms/android-15/arch-arm -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -lc -lm' --extra-libs='-llog -lstlport_static -lstdc++' --enable-pic --enable-neon --enable-armv5te --enable-armv6 --enable-armv6t2 --disable-stripping
...
CXX=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
AS=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
ARFLAGS=rcD
AR_O=$@
RANLIB=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -MMD -MP -fPIC -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -Os -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -DANDROID -Wa,--noexecstack -I. -I/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/include -march=armv5 -std=c11 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS= -MMD -MP -fPIC -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -Os -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -DANDROID -Wa,--noexecstack -I. -I/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/include -fno-exceptions -fno-rtti -I/opt/android-ndk-r14b/sources/cxx-stl/system/include -I/opt/android-ndk-r14b/sources/cxx-stl/stlport/stlport -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -MMD -MP -fPIC -ffunction-sections -funwind-tables -fstack-protector -D__ARM_ARCH_5__ -D__ARM_ARCH_5T__ -D__ARM_ARCH_5E__ -D__ARM_ARCH_5TE__ -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -Os -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -DANDROID -Wa,--noexecstack -I. -I/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/include -march=armv5 -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/opt/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -L/opt/android-ndk-r14b/platforms/android-15/arch-arm/usr/lib -L/opt/android-ndk-r14b/sources/cxx-stl/stlport/libs/armeabi -shared --sysroot=/opt/android-ndk-r14b/platforms/android-15/arch-arm -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -lc -lm  -march=armv5 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lm -lz -pthread -llog -lstlport_static -lstdc++ 
