...
ndk_tool	=${ndk_root}/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64
ndk_bin		=${ndk_root}/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin
...
pushd ../../../../AVLib/AVBase/ffmpeg-3.2.5
